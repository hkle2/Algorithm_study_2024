...
SELECT HISTORY_ID,
    CASE
        WHEN DURATION >= 90 THEN ROUND(DAILY_FEE * 0.85 * DURATION, 0)
        WHEN DURATION >= 30 THEN ROUND(DAILY_FEE  * 0.92 * DURATION, 0)
        WHEN DURATION >= 7 THEN ROUND(DAILY_FEE  * 0.95 * DURATION, 0)
